...
do
    python scripts/eval_translation.py cfg=cfgs/couchmoving/eval.yml \
        env_cfg.fixed_max_ep_len=200 env_cfg.trajectories_dataset="datasets/couchmoving/couch_4_corridorrange_20_24/dataset_teacher.pkl" \
