...
## Stack 3-2-1 or 4-3-2-1 pyramid - Row 11-12
...
do
    ...
    do
        ...
        python scripts/eval_translation.py cfg=cfgs/blockstacking/eval.yml \
            env_cfg.trajectories_dataset=datasets/blockstacking/dataset_pyramid-${i}.pkl \
            env_cfg.trajectories=datasets/blockstacking/dataset_pyramid-${i}_train_ids.npy n_envs=16 test_n=128 env_cfg.fixed_max_ep_len=${max_ep_len} \
